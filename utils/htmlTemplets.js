export const signUpHtml = ({ link, email, userName }) => {
    return `<!DOCTYPE HTML
      ...
      <![endif]-->
          <div class="u-row-container" style="padding: 0px;background-color: transparent">
            <div class="u-row"
              ...
              <div
                style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-image: url('images/image-1.png');background-repeat: no-repeat;background-position: center top;background-color: transparent;">
                              ...
                              <div
                                ...
                                <p style="font-size: 14px; line-height: 170%;"><span
                                    style="font-size: 20px; line-height: 34px;"><strong><span
                                        style="line-height: 34px; font-size: 20px;">Hi ${userName},</span></strong></span>
                                </p>
                              </div>
                            </td>
                          </tr>
                          ...
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <div
                                style="font-size: 14px; line-height: 170%; text-align: center; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 170%;"><span
                                    style="font-size: 16px; line-height: 27.2px;">Please Verify that your email address
                                    is </span><span style="font-size: 16px; line-height: 27.2px;">${email} and
                                    that you entered it when </span><span
                                    style="font-size: 16px; line-height: 27.2px;">signing up for Saraha App.</span></p>
                              </div>
                          ...
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <div align="center">
                                ...
                                <a href="${link}" target="_blank" class="v-button v-size-width"
...
export const forgetCodeHtml = ({ code, userName }) => {
    return `<!DOCTYPE HTML
  PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
  <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml"
  xmlns:o="urn:schemas-microsoft-com:office:office">
                        ...
                        <tr>
                          <td class="v-container-padding-padding"
                            ...
                            <div
                              style="font-size: 14px; line-height: 170%; text-align: center; word-wrap: break-word;">
                              <p style="font-size: 14px; line-height: 170%;"><span
                                  style="font-size: 16px; line-height: 27.2px;">Here is Your code for resetting the password</p>
                            </div>
                      ...
                      <tbody>
                        <tr>
                          <td class="v-container-padding-padding"
                            ...
                            <div align="center">
                              <!--[if mso]><table border="0" cellspacing="0" cellpadding="0"><tr><td align="center" bgcolor="#000000" style="padding:10px 20px;" valign="top"><![endif]-->
                              <button  type="button" class="v-button v-size-width"
                                style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #000000; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:50%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
                                <span style="display:block;padding:10px 20px;line-height:120%;"><span
                                    style="font-size: 16px; line-height: 19.2px;"><strong><span
